...
class RelianceSpider(scrapy.Spider):
    ...
    pageno = 2
    start_urls = [
        'https://www.reliancedigital.in/dslr-cameras/c/S101110?searchQuery=:relevance:availability:Exclude%20out%20of%20Stock&page=0']
    ...
    def parse(self, response, **kwargs):
        ...
        for page in [
            'https://www.reliancedigital.in/mirrorlesss-cameras/c/S101119?searchQuery=:relevance:availability:Exclude%20out%20of%20Stock&page=0',
